...
public class WindTestApplication extends Application {
    ...
    private final static String DB_FILE_NAME = "dmsf.db";
    ...
    private void copyDatabaseFile() {
        try{
            ...
            if (!dbFile.exists()){
                ...
                InputStream inputStream = getResources().openRawResource(R.raw.dmsf);
                File file = new File(getExternalFilesDir("")+"dmsf.db");
