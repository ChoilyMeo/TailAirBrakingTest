...
import com.choily.serialportlib.serialport.RF433PowerControl;
...
public class WindTestApplication extends Application {
    ...
    public void onCreate() {
        ...
        XLog.i("系统启动。版本号：" + BuildConfig.VERSION_NAME + "，Is use test data：" + BuildConfig.USE_LOCAL_TEST_DATA);
    }
    ...
    public boolean backupDbFile(){
        return SqliteDatabaseContext.getInstance().backupDbFile(DB_FILE_NAME);
    }
