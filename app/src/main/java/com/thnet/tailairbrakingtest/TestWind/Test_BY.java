...
public class Test_BY extends TestContent {
    public Test_BY() {
        _testName = CStrTestName_BY;
        _shortTestName = CStrShortTestName_BY;
        _voiceFileNameBegin = TipSoundPlayer.nVoiceFileNameBegin_by;
        _voiceFileNameCompleted = TipSoundPlayer.nVoiceFileNameCompleted_by;
        _voiceFileNameNotCompleted = TipSoundPlayer.nVoiceFileNameNotCompleted_by;
        _TestCommandCode = CTestWindProtocel.TestCommand.TestBY;
        _analyseMax = SysParamsAll.get_byAnalyseMax();
        _analyseMin = SysParamsAll.get_byAnalyseMin();
        _standardKeepTime = SysParamsAll.get_byStandardTime();
        _standardDrop = SysParamsAll.get_byStandardDrop();
        _standardLeak = SysParamsAll.get_byStandardLeak();
        _isValid_ZGYL = true;
        _isValid_BYSJ = true;
        _isValid_JYL = true;
        _isValid_LXL = true;
