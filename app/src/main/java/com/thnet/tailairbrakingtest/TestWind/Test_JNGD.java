...
public class Test_JNGD extends TestContent {
    public Test_JNGD()    {
        _testName = CStrTestName_JNGD;
        _shortTestName = CStrTestName_JNGD;
        ...
        _TestCommandCode = CTestWindProtocel.TestCommand.TestJNGD;
        ...
        _standardLeak = 10000;
        _standardDropTimeMin = SysParamsAll.get_gdzdStandardDropTimeMin();
        _standardDropTimeMax = SysParamsAll.get_gdzdStandardDropTimeMax();
        _isValid_JYSJ = true;
